...
export default function Timeline() {
  ...
  return (
    <div className={cn("overflow-hidden timeline-background w-full bg-beige text-darkgrey", "p-12", "relative")}>
      <div className="text-center">
        <StackedTextDark text="Timeline" fontSize="72px" />
      </div>
      <div className={cn("w-full py-8", "flex flex-col-reverse gap-y-12")} ref={listRef}>
        <div className="lg:px-20 lg:flex lg:items-center lg:justify-center">
          <ol className={cn("relative border-s border-green border-l-2 lg:border-none", "lg:grid lg:grid-cols-2 lg:max-w-[80%]")}>
            <motion.div
              id="progress"
              style={{
