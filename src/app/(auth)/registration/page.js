    ...
    try {
        ...
        if (duplicateEmails.length > 0) {
            duplicateEmails.forEach(({ index, email }) => {
                toast.error(
                    `Participant ${index + 1}: ${email} is already registered for the hackathon`
                );
            });
    ...
    render={({ field }) => (
      <>
        <select
          ...
          className="w-full px-3 py-2 border border-green bg-transparent text-white rounded-md focus:outline-none focus:ring-2 focus:ring-pink"
        >
          <option className="text-darkgrey hover:text-white" value="" disabled>
            Select Year of Study
          </option>
          <option className="text-darkgrey hover:text-white" value="1">1</option>
          <option className="text-darkgrey hover:text-white" value="2">2</option>
          <option className="text-darkgrey hover:text-white" value="3">3</option>
          <option className="text-darkgrey hover:text-white" value="4">4</option>
          <option className="text-darkgrey hover:text-white" value="other">Other</option>
        </select>
        {field.value === "other" && (
          <input
...
>
  {isSubmitting ? "Submitting..." : "Submit Registration"}
        ...
        <div className="mt-6 text-center space-y-2">
					...
					<p>
						<span className="text-white">Contact Mohammed Imaduddin </span>
						<a href="tel:9052812005" className="text-green hover:text-pink transition-colors">
							+919052812005
						</a>
					</p>
				</div>
